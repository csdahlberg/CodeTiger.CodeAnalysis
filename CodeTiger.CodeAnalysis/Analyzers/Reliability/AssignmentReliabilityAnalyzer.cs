    ...
    public class AssignmentReliabilityAnalyzer : DiagnosticAnalyzer
    {
        internal static readonly DiagnosticDescriptor
            AssignmentResultsShouldNotBeUsedDescriptor = new DiagnosticDescriptor("CT2008",
                "The result of an assignment should not be used.",
                "The result of an assignment should not be used.", "CodeTiger.Reliability",
        ...
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics
        {
            get
            {
                return ImmutableArray.Create(AssignmentResultsShouldNotBeUsedDescriptor);
            }
        }
